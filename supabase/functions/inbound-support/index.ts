    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:560px;width:100%;">
        ...
        <tr><td style="padding:32px;">
          ...
          ${p(`Please visit our <a href="${APP_URL}/contact" style="color:#1a1a1a;font-weight:600;">Contact page</a> to reach us — our contact form goes directly to our support team.`)}
        ...
        <tr><td style="background:#f9f9f9;padding:16px 32px;border-top:1px solid #eeeeee;">
          <p style="margin:0;font-size:12px;color:#aaa;">
            ...
            <a href="${APP_URL}/contact" style="color:#aaa;text-decoration:none;">Contact Support</a>
          </p>
        </td></tr>
      </table>
    </td></tr>
