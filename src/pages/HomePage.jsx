...
const LockIcon = () => (
  <svg
    ...
    aria-hidden="true"
  >
    <rect x="12" y="34" width="48" height="30" rx="7" stroke="#7aaa2e" strokeWidth="3" />
    <path
      ...
      strokeLinecap="round"
    />
    <circle cx="36" cy="49" r="4" fill="#7aaa2e" />
    <line x1="36" y1="53" x2="36" y2="58" stroke="#7aaa2e" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
