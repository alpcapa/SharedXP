...
const STATUS_TAGS = {
  ...
  in_progress:     { label: "XP in progress", cls: "xp-tag-inprogress" },
          ...
          {isMenuOpen && (
            <div className="user-dropdown" role="menu">
              ...
              <Link to="/history" className="user-dropdown-link user-dropdown-xp-history" role="menuitem">
                <span>My <span style={{color: "var(--brand)", fontWeight: 800, fontFamily: "var(--font-display)", fontSize: "1.15em", lineHeight: 1}}>XP</span> History</span>
                {activeTags.length > 0 && (
