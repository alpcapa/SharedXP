...
// ISO 4217 currency code for each country code.
// Countries that use USD or EUR as official currency are mapped accordingly.
export const COUNTRY_CURRENCY = {
  AF: "AFN", AL: "ALL", DZ: "DZD", AD: "EUR", AO: "AOA",
  AR: "ARS", AM: "AMD", AU: "AUD", AT: "EUR", AZ: "AZN",
  BH: "BHD", BD: "BDT", BY: "BYN", BE: "EUR", BZ: "BZD",
  BJ: "XOF", BT: "BTN", BO: "BOB", BA: "BAM", BW: "BWP",
  BR: "BRL", BN: "BND", BG: "BGN", BF: "XOF", BI: "BIF",
  KH: "KHR", CM: "XAF", CA: "CAD", CV: "CVE", CF: "XAF",
  TD: "XAF", CL: "CLP", CN: "CNY", CO: "COP", KM: "KMF",
  CG: "XAF", CR: "CRC", HR: "EUR", CU: "CUP", CY: "EUR",
  CZ: "CZK", DK: "DKK", DJ: "DJF", DO: "DOP", CD: "CDF",
  ...
  JP: "JPY", JO: "JOD", KZ: "KZT", KE: "KES", XK: "EUR",
  KW: "KWD", KG: "KGS", LA: "LAK", LV: "EUR", LB: "LBP",
  LS: "LSL", LR: "LRD", LY: "LYD", LI: "CHF", LT: "EUR",
  LU: "EUR", MO: "MOP", MG: "MGA", MW: "MWK", MY: "MYR",
  MV: "MVR", ML: "XOF", MT: "EUR", MR: "MRU", MU: "MUR",
  MX: "MXN", MD: "MDL", MC: "EUR", MN: "MNT", ME: "EUR",
  MA: "MAD", MZ: "MZN", MM: "MMK", NA: "NAD", NP: "NPR",
  NL: "EUR", NZ: "NZD", NI: "NIO", NE: "XOF", NG: "NGN",
  KP: "KPW", MK: "MKD", NO: "NOK", OM: "OMR", PK: "PKR",
  PS: "ILS", PA: "USD", PG: "PGK", PY: "PYG", PE: "PEN",
  PH: "PHP", PL: "PLN", PT: "EUR", QA: "QAR", RO: "RON",
  RU: "RUB", RW: "RWF", SA: "SAR", SN: "XOF", RS: "RSD",
  SL: "SLE", SG: "SGD", SK: "EUR", SI: "EUR", SO: "SOS",
  ZA: "ZAR", KR: "KRW", SS: "SSP", ES: "EUR", LK: "LKR",
  SD: "SDG", SR: "SRD", SE: "SEK", CH: "CHF", SY: "SYP",
  TW: "TWD", TJ: "TJS", TZ: "TZS", TH: "THB", TL: "USD",
  TG: "XOF", TT: "TTD", TN: "TND", TR: "TRY", TM: "TMT",
