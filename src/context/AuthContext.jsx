    ...
    () => ({
      ...
      onEmailSignUp: async (newUser) => {
        try {
          ...
          // password / confirmPassword: never stored outside Supabase auth.
          // photo: base64 data URLs would bloat the JWT; users re-upload via
          //   My Profile after first login. URL photos work via onUpdateProfile.
          const {
            password,
